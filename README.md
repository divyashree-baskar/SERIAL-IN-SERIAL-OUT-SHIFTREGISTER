...
![image](https://github.com/user-attachments/assets/a6fbf1fc-2011-4908-bb1d-93d72454c544)

**TIMING DIGRAMS FOR SISO Shift Register**
![image](https://github.com/user-attachments/assets/6b36738b-dac6-4832-b8d4-1be09a21cb6a)

**RESULTS**
Thus,SISO shift register using verlog and validatin their functionality using their functional tables has successful execution og the program
